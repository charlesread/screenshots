...
$makeResult = $db_handle->runQuery("SELECT DISTINCT make FROM cars_members ORDER BY make ASC");
?>
<html>
<head>
<link href="stylemembers.css" type="text/css" rel="stylesheet" />
...
<body>
    ...
    <form method="POST" name="search" action="indexmember.php">
        <div id="demo-grid">
            <div class="search-box">
                ...
                <tbody>
                <?php
                    $query = "SELECT * from cars_members";
                    $i = 0;
